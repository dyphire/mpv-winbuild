...
build() {
    ...
    ninja -C $buildroot/build$bit shaderc && ninja -C $buildroot/build$bit spirv-cross && ninja -C $buildroot/build$bit harfbuzz
    ninja -C $buildroot/build$bit mujs || ninja -C $buildroot/build$bit mujs-removebuild && ninja -C $buildroot/build$bit mujs;
    ninja -C $buildroot/build$bit mpv || ninja -C $buildroot/build$bit mpv || ninja -C $buildroot/build$bit mpv || ninja -C $buildroot/build$bit mpv
